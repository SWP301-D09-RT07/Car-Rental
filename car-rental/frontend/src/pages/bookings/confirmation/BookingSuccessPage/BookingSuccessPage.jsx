...
import { getBookingByTransactionId } from "@/services/api"
    ...
    useEffect(() => {
        ...
        if (bookingDataFromApi) {
          ...
          setBookingDetails({
            ...
            amount: bookingDataFromApi.depositAmount, // Or total amount, depending on what's available
            ...
            totalAmount: bookingDataFromApi.totalAmount || 0, // This needs to come from financials
            depositAmount: bookingDataFromApi.depositAmount || 0,
