    ...
    <div className="bg-gradient-to-br from-green-50 via-white to-blue-50 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl lg:text-6xl font-black bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent mb-6">Đã gửi đăng ký thành công!</h1>
