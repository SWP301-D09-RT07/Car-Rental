...
public class UserController {
    ...
    @Autowired
    public UserController(UserService userService, JwtTokenProvider jwtTokenProvider, UserRepository userRepository, BookingService bookingService, CarRepository carRepository, CarMapper carMapper, StatusRepository statusRepository, BookingRepository bookingRepository) {
...
//}
    ...
    public ResponseEntity<List<UserDTO>> getRecentBookingUsers(@RequestParam(defaultValue = "5") int size) {
        return ResponseEntity.ok(userService.getRecentBookingUsers(size));
    }
